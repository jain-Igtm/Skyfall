...
scene.fog = new THREE.FogExp2(0x05080b, 0.0115)
scene.add(new THREE.AmbientLight(0x607077, 0.38))
const coldFill = new THREE.HemisphereLight(0x839ea4, 0x120d0b, 0.52)
scene.add(coldFill)
...
gun.add(muzzle)
const muzzleLight = new THREE.PointLight(0xff893d, 0, 4.5, 2)
...
function cycleBrightness(): void {
  ...
  renderer.toneMappingExposure = [1.45, 1.62, 1.8][state.brightnessIndex]
  refreshPauseSettings()
}
